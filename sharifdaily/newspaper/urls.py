...
urlpatterns = patterns('sharifdaily.newspaper.views',
	...
	url(r'^articles/comments/page/(?P<page>[0-9]+)/$', 'get_article_comments'),
	url(r'^reports/comments/page/(?P<page>[0-9]+)/$', 'get_report_comments'),
	...
	url(r'^articles/likes/post$', 'post_article_like'),
	url(r'^reports/likes/post$', 'post_report_like'),
